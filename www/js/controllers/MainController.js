...
app.controller('MainCtrl', function($scope, $http, $ionicPopup, $timeout) {
  ...
  $scope.paramsFirstGame = {"objects_active": true, "actions_active": false, "nb_objects":2, "nb_actions":2, "text_descr": true, "activate_img": true, "text_size":25, "nb_questions":4, "nb_try":2};
  $scope.paramsSecondGame = { "play_type" : "action", "nb_rooms":3, "text_descr": true, "activate_img": true, "text_size":25, "nb_questions":4, "nb_try":2};
